                ...
                {item.link && (
                  ...
                  >
                    <Image
                      ...
                      alt="Link icon"
                    />
                    <span className="mobile-link ml-2  text-lightText transition-colors duration-500">
                      {item.link}
                    </span>
                    <span className="non-mobile-link ml-2 text-lightText transition-colors duration-500">
                      website
                    </span>
                  </a>
                )}
